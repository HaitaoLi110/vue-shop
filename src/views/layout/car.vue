<template>
  <div class="cart">
      ...
      <div class="cart-content">
        ...
        <div class="cart-empty" v-if="!cartList.length">购物车数量为空</div>
        <div class="cart-promotion" v-show="cartList.length">
          <span>使用优惠券</span>
          <input type="text" v-model="promotionCode">
          <span class="cart-control-promotion" @click="handlePromotion">验证</span>
        </div>
        <div class="cart-footer">
            ...
            <div class="cart-footer-desc">
              应付总额：{{cartAll-promotion}}
              <template v-if="promotion">优惠（{{promotion}}）</template>
            </div>
            <div class="cart-footer-desc">
  ...
  export default{
    ...
    methods:{
      ...
      handleCount( index, count){
        ...
        this.$store.commit('editCardCount',{
